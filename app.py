...
# ════════════════════════════════════════════════════════════
    ...
    template_csv = (
        ...
        '"Bopal, Ahmedabad, Gujarat",restaurant,80000,"Near D-Mart"\n'
        '"CG Road, Ahmedabad, Gujarat",restaurant,120000,"Main commercial street"\n'
        '"Prahlad Nagar, Ahmedabad, Gujarat",restaurant,95000,"Corporate hub"\n'
    )
    st.download_button(
